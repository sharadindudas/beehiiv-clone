        ...
        <div className="bg-gray-100 p-4 rounded-lg flex-1">
            ...
            <div className="flex flex-wrap items-end justify-center gap-5">
                ...
                <form.Field name={`conditions.conditions[${index}].data.filters.operator`}>
                    {(subField) => {
                        let operatorList = SEGMENT_AUTOMATION_ACTION_OPERATORS_DROPDOWN.common;
                        if (condition.id === "enrollment") {
                            operatorList = SEGMENT_AUTOMATION_ACTION_OPERATORS_DROPDOWN.common;
                        }
                        return (
                            <Select
